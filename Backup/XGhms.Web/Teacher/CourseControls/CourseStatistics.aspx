<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseStatistics.aspx.cs" Inherits="XGhms.Web.Teacher.CourseControls.CourseStatistics" %>
        ...
        <div class="span9">
            <div class="row-fluid">
                <div class="page-header">
				    <h1><span id="title_h1">课程作业统计</span> <small id="h1small"> </small></h1>
			    </div>
                <div id="placeholder" style="width:80%;height:300px;"></div>

                <div class="form-actions">
					<a id="successchangelink" class="btn" href="MyCourse.aspx">返回</a>
				</div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        $.ajax({ //获取班级数据
            ...
            data: "action=GetCourseInfoByID&id=" + hwid,
            cache: false,
            async: true,
        ...
        $("#placeholder").bind("plothover", function (event, pos, item) {
            if (item) {
                if (previousPoint != item.dataIndex) {
                    ...
                    var contents = "作业名称：" + changci + "<br />平均分：" + y + "<br />作业时间：" + shijian;
