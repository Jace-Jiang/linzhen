                ...
                <div class="pull-left third-party l-30 pt-40" style="width:600px;min-height: 350px;">
					...
					<div class="clearfix t-25">
                        <div class="pull-left sina-div r-10 b-10" style="_width: 110px;">
                            <img alt="学生作业管理系统" src="Img/jxnu.jpg" width="110px" height="110px" />
						</div>
                        <div style=" width:380px; font-size:30px; margin-top:20px; text-align:center; line-height:35px;">江西师范大学<br />学生作业管理系统</div>
					</div>
					<p class="fc999" style="max-width: 470px;font-size:14px;">欢迎使用学生作业管理系统，请先登录系统然后根据您的角色进入相应的管理界面，如果在使用当中有任何问题，请联系管理员。</p>
				</div>
                <!-- 当没有登录的时候显示以下登录界面 -->
