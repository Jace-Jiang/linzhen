<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewMessage.aspx.cs" Inherits="XGhms.Web.Teacher.Message.NewMessage" %>
...
<script type="text/javascript">
    ...
    function sendMsg() {
        ...
        $.ajax({ //发送消息
            ...
            dataType: "json",
            url: "/Handles/MessageHandler.ashx",
            data: "action=InsertNewMsg&msgCon=" + escape(msgCon) + "&userList=" + userList,
            success: function (data) {
                alert(data.msg);
            },
            errpr: function () {
